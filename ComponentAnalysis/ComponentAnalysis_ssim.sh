...
# backup
cp ~/.local/lib/$PYTHONVERSION/site-packages/skimage/metrics/_structural_similarity.py ssim_backup.py
...
# recovery
cp ssim_backup.py ~/.local/lib/$PYTHONVERSION/site-packages/skimage/metrics/_structural_similarity.py
